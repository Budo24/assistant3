...
def test_activity_exist() -> None:
    ...
    single_date = monthly_plan_plugin.SingleDate('2022-07-30', 'thirty')
    single_date.activities = {'15 0 18 0': 'playing football'}
    time_range_numbers = [15, 0, 16, 0]
    activity_exist = monthly_plan_plugin.activity_exist(single_date, time_range_numbers)
...
def test_add_to_xls() -> None:
    """Test adding to xls."""
    time_range_activity = ''
    date_to_xls = monthly_plan_plugin.SingleDate('2022-01-01', 'thirty')
...
def test_add_activity_to_time_range() -> None:
    ...
    with patch('assistant3.common.helpers.date') as mock_date:
        ...
        monthly_plan.activity_values['time_range_'] = '20 0 20 30'
        monthly_plan.single_day = monthly_plan.give_date_from_monthly_plan('2010-10-09')
